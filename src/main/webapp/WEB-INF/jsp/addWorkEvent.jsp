...
<html>
<head>
    <title><spring:message code="event.add.event"/></title>
...
<div class="container" role="main">
    <div class="page-header">
        <h1><spring:message code="event.add.event"/> dla pojazdu ID: ${eventDTO.carId}</h1>

        <div class="row">
            <div class="col-md-4">
                <div id="From">
                    <label for="From_Input"><spring:message code="where"/> : </label>
                    <input id="From_Input">
        ...
        <div class="row">
            ...
            <form:form modelAttribute="eventDTO" id="eventForm" action="/addWorkEvent" method="post">
