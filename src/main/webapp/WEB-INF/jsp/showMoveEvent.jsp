...
<c:url value="/resources/showMoveEvent.js" var="showMoveEvent" />
...
<body>
    ...
    <div class="container" role="main">
        <div class="page-header">
            <h1><spring:message code="event.show.title" /> ${event.id}</h1>
    ...
    <script src="${showMoveEvent}"></script>
    ...
    <script>
        ...
        showRoute(${event.pathAsJsonArray});
    </script>
</body>
</html>
